...
THRESHOLD_dict={'All':0.8,'CRC':0.9}
relationship_between_features_labels={'All':{1:'Tumor',0:'No tumor'},'CRC':{1:'More tumors than median',0:'Less tumors than median'}}
P_VALUE_THRESHOLD=0.05
LEVEL_TO_REDUCE=6
Groups_list=['All','CRC']
prediction_sort=['Binary','Multi']
