...
mapping_file_path=r'C:\sharon\second_degree\Initial_project\Projects\Crohn_project\data\IIRN_map_Yoram.txt'
biom_file_path=r'C:\sharon\second_degree\Initial_project\Projects\Crohn_project\data\IIRN_feature-table.biom'
N_SPLITS=2
